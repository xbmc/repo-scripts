...
def set_library_tags(tags,whitelist=None,save=True,clear=False):
    ...
    if tags and not clear:
        ...
        # Defensive: addon_data() may have failed and left whitelist as None.
        # Treat None as an empty list so the loop below and sort() are safe.
    ...
    # Defensive: handle the clear=True path where whitelist was never set.
    if whitelist is None:
        whitelist = []
