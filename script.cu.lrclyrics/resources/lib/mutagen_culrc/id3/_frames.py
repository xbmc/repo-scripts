        ...
        if id3.version >= id3._V24:
            ...
            if tflags & Frame.FLAG24_UNSYNCH or id3.f_unsynch:
                try:
                    ...
                    # https://bitbucket.org/lazka/mutagen_culrc/issue/210
                    # https://bitbucket.org/lazka/mutagen_culrc/issue/223
                    pass
            ...
            if tflags & Frame.FLAG24_COMPRESS:
                try:
                    ...
                    # the initial mutagen_culrc that went out with QL 0.12 did not
...
for k, v in iteritems(globals()):
    if isinstance(v, type) and issubclass(v, Frame):
        v.__module__ = "mutagen_culrc.id3"
