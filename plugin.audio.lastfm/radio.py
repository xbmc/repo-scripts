...
#        self._add_listitem(LANGUAGE(32059) % user, '', '["user.getLovedTracks", "%s", "user"]' % user, '', True, 'list', 'dateadded')
        ...
        self._add_listitem(LANGUAGE(32065) % user, '', 'lastfm://user/%s/personal' % user, 'DefaultPlaylist.png', False, 'play', 'none')
        self._add_listitem(LANGUAGE(32066) % user, '', 'lastfm://user/%s/recommended/100' % user, 'DefaultPlaylist.png', False, 'play', 'none')
