...
kodi_mapping = {
    ...
    'track_name': 'Title',
    'artist_name': 'Artist',  # 'ArtistString',
    'release_name': 'Album',
    ...
    # 'track_mbid': '',  # Not supported by Kodi as of v18
    # 'work_mbids': '',  # Not supported by Kodi as of v18
    'tracknumber': 'Track',
    # 'isrc': '',  # Not supported by Kodi as of v18
    # 'spotify_id': '',  # Not supported by Kodi as of v18
    ...
    'url': 'URL',
    'duration': 'Duration',  # seconds; TODO: Convert to ms?
