...
from mutagen_culrc._util import resize_bytes, DictMixin
from mutagen_culrc._compat import string_types, long_, PY3, izip
...
class ASFInfo(StreamInfo):
    ...
    (:class:`mutagen_culrc.text`)
    """

    codec_name = u""
    """Name and maybe version of the codec used. Example:
    ``Windows Media Audio 9.1`` (:class:`mutagen_culrc.text`)
    """

    codec_description = u""
    """Further information on the codec used.
    Example: ``64 kbps, 48 kHz, stereo 2-pass CBR`` (:class:`mutagen_culrc.text`)
    """
...
class ASF(FileType):
    ...
    :raises mutagen_culrc.asf.error: In case loading fails
    """
    ...
    def save(self, filename=None, padding=None):
        ...
        :param padding: A callback which returns the amount of padding to use.
            See :class:`mutagen_culrc.PaddingInfo`

        :raises mutagen_culrc.asf.error: In case saving fails
        """
