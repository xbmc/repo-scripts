...
Current.PrecipitationAmount    (total amount of rain and snow)
Current.Cloudiness             (cloud coverage)
Current.AirQuality
Current.Pollen                 (allergens)
...
Hourly.%i.PrecipitationAmount  (total amount of rain and snow)
Hourly.%i.WindSpeed
...
Daily.%i.PrecipitationAmount   (total amount of rain and snow)
