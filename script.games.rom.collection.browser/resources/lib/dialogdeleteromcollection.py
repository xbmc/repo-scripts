...
class RemoveRCDialog(xbmcgui.WindowXMLDialog):
	...
	def onInit(self):
		...
		#Delete Options
		rcDeleteOptions = ['Delete games and configuration','Delete games only']
	...
	def onClick(self, controlID):
			...
			if(self.selectedRomCollection != None):
				...
				if(self.romDelete == 'RCollection'):
					...
					if(success == False):
						...
						xbmcgui.Dialog().ok('Error', 'Error Deleting Rom Collection')
		...
		#Rom Collection list
			...
			if(selectedDeleteOption == 'Delete games only'):
				self.romDelete = 'Roms'
			else:
