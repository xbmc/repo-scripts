...
class GUI( xbmcgui.WindowXML ):
    ...
    def define_controls(self):
        ...
        self.list_contacts = xbmcgui.ControlList(973, list_top_pos, 300, 300, font = 'font12', selectedColor = "0xFF000000", textColor = '0xFFFFFFFF', buttonTexture = 'button-nofocus.png', buttonFocusTexture = 'button-focus.png', itemHeight = 25, space = 2)
