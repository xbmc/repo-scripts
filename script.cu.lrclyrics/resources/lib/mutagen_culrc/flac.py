...
from mutagen_culrc._util import resize_bytes, MutagenError, get_size
from mutagen_culrc._tags import PaddingInfo
...
class StreamInfo(MetadataBlock, mutagen_culrc.StreamInfo):
...
class FLAC(mutagen_culrc.FileType):
    """A FLAC audio file.
    ...
    * pictures -- list of embedded pictures
    ...
    def __read_metadata_block(self, fileobj):
        ...
        if block_type._distrust_size:
            ...
            # http://code.google.com/p/mutagen_culrc/issues/detail?id=52
